...
initaiting_window = pygame.image.load("C:/Users/kmamt/Downloads/open.png")
initaiting_window = pygame.transform.scale(initaiting_window, ((width, height + 100)))
x_img = pygame.image.load('C:/Users/kmamt/Downloads/xx.png')
o_img = pygame.image.load('C:/Users/kmamt/Downloads/oo.png')
...
def draw_status():
    ...
    text = font.render(message, 1, (139,0,0))

    screen.fill((216,191,216), (0, 300, 300, 100))
